...
const GovernmentFooter = () => {
  return (
    <footer className="bg-[#20559A] text-white py-10 px-5 font-sans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <a href="#" className="w-9 h-9 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white hover:from-purple-600 hover:to-pink-600 transition-colors">
