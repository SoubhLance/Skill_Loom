      ...
      <div className="min-h-screen bg-gray-100 p-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex gap-8 mb-8">
            ...
            {/* Login / Signup */}
            {!user && (
              // ... (existing login form stays the same)
              <div className="shadow-xl rounded-2xl w-full max-w-sm relative overflow-hidden">
                {/* Your login/signup form here */}
              </div>
            )}

            {/* 🔹 Improved Logged-in Welcome Card */}
            {user && (
              <div className="bg-gradient-to-br from-green-50 to-green-100 shadow-2xl rounded-3xl p-8 w-full max-w-sm border border-green-200">
                <div className="text-center relative">
                  {/* Decorative glow */}
                  <div className="absolute -top-6 -right-6 w-16 h-16 bg-green-400 rounded-full opacity-20 blur-2xl"></div>
                  <div className="absolute -bottom-6 -left-6 w-16 h-16 bg-green-300 rounded-full opacity-20 blur-2xl"></div>
                  ...
                  <p className="text-sm text-gray-700 mb-6 bg-white/70 inline-block px-3 py-1 rounded-full shadow-sm">
                    {user.email}
                  </p>
                  ...
                  <button
                    ...
                    className="w-full py-3 rounded-xl bg-gradient-to-r from-green-500 to-emerald-600 text-white font-semibold text-sm tracking-wide shadow-md hover:from-green-600 hover:to-emerald-700 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300"
                  >
                    Go to Dashboard
                  </button>
                </div>
